...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lb_p_ing = QtWidgets.QLabel(Form)
        self.lb_p_ing.setObjectName("lb_p_ing")
        self.horizontalLayout_2.addWidget(self.lb_p_ing)
        self.lb_p_ed = QtWidgets.QLabel(Form)
        self.lb_p_ed.setObjectName("lb_p_ed")
        self.horizontalLayout_2.addWidget(self.lb_p_ed)
    ...
    def retranslateUi(self, Form):
        ...
        self.lb_p_ing.setText(_translate("Form", "Preparing"))
        self.lb_p_ed.setText(_translate("Form", "Prepared"))
        self.bt_remove.setText(_translate("Form", "Remove"))
        self.label.setText(_translate("Form", "Quantity : "))
        self.le_quantity.setText(_translate("Form", "0"))
