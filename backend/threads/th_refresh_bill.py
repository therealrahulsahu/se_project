...
class ThreadRefreshCustomerBill(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            order_data = myc_o.find_one({'_id': self.parent_class.customer_id},
            ...
            self.parent_class.curr_wid.bt_refresh_bill.setEnabled(True)
